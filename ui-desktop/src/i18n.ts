...
const en: Record<string, string> = {
  ...
  'composer.steerHint': 'Running - Enter steers this turn, Cmd/Ctrl+Enter queues for after',
  'composer.queuedNotice': 'Queued for after this turn: {text}',
  'composer.send': 'Send',
  'composer.stop': 'Stop',
  'composer.add': 'Add context',
  'composer.addFiles': 'Add files',
  'composer.addFolder': 'Add folder',
  'composer.setGoal': 'Set as goal',
  'composer.goal': 'Goal',
  'composer.clearGoal': 'Return to normal mode',
  'composer.file': 'File',
  'composer.folder': 'Folder',
  'composer.inspectAttachments': 'Please inspect the attached items.',
  'composer.attachmentLimit': 'Attach at most 8 local files or folders.',
  'composer.imageLimit': 'Attach at most 4 images.',
  ...
  'effort.on': 'On',
  'effort.on.desc': 'Use the model provider\'s default reasoning',
  'effort.none': 'None',
  'effort.none.desc': 'No reasoning effort',
  'effort.minimal': 'Minimal',
  'effort.minimal.desc': 'Minimum supported reasoning effort',
  'effort.low': 'Low',
  'effort.low.desc': 'Fast, light reasoning',
  'effort.medium': 'Medium',
  'effort.medium.desc': 'Balanced reasoning effort',
  'effort.high': 'High',
  'effort.high.desc': 'High reasoning effort',
  'effort.xhigh': 'Extra high',
  'effort.xhigh.desc': 'Extended reasoning effort',
  'effort.max': 'Max',
  ...
  'context.toolsCompacted': 'Tool results compacted ({before} → {after} tokens, {count} results). The model sees small receipts; exact outputs remain in conversation history.',
  ...
  'settings.compaction.hint': 'Context threshold and strategy',
  ...
  'general.responseLanguage': 'Reply language',
  'general.responseLanguagePlaceholder': 'For example: Chinese; Friday will prefer this language',
  ...
  'models.keyEmptyShort': 'Paste API key and press Enter',
  'models.keyOptional': 'Leave blank to keep the saved key',
  'models.removeKey': 'Remove the saved API key',
  'models.saved': 'Saved',
  'models.refreshed': '{n} models refreshed',
  'models.keyRemoved': 'API key removed',
  'models.enabled': 'Provider enabled',
  'models.disabled': 'Provider disabled',
  'models.enableNeedsKey': 'Add an API key first',
  'models.refresh': 'Refresh models',
  'models.enable': 'Enable provider',
  'models.disable': 'Disable provider',
  'models.modelCount': '{n} models',
  'models.customTitle': 'OpenAI-compatible',
  'models.customBrief': 'Custom endpoints',
  'models.add': 'Add',
  ...
  'compaction.desc': 'Choose when Friday rewrites model-facing context. Full conversation history stays on disk.',
  'compaction.automatic': 'Automatic compaction',
  'compaction.automaticNote': 'When off, Friday stops at the threshold and asks you to compact manually.',
  'compaction.threshold': 'Threshold',
  'compaction.strategy': 'Strategy',
  'compaction.insert': 'Insert and compact',
  'compaction.twoStage': 'Tool receipts, then insert and compact',
  'compaction.manualNote': 'Manual compaction remains available below while a compaction plugin is enabled.',
  'compaction.compactNow': 'Compact now',
  'compaction.compacting': 'Compacting…',

  // Plugins
  'plugins.title': 'Plugins',
  'plugins.desc': 'Harness capabilities use one plugin registry for tools, prompt sections, wrappers, memory, and compaction services. Switching one off removes only what that plugin contributes.',
  'plugins.required': 'Required',
  'plugins.on': 'On',
  'plugins.off': 'Off',
  'plugins.tools': 'Tools: {tools}',
  'plugins.prompt': 'Prompt section',
  'plugins.wrapper': 'Tool wrapper',
  'plugins.memory': 'Memory provider',
  'plugins.noTools': 'No contributed capabilities',
  'plugins.compaction': 'Context compaction provider',
...
const zh: Record<string, string> = {
  ...
  'composer.steerHint': '运行中——Enter 插话引导本轮，Cmd/Ctrl+Enter 排队稍后执行',
  'composer.queuedNotice': '已排队，本轮结束后执行：{text}',
  'composer.send': '发送',
  'composer.stop': '停止',
  'composer.add': '添加上下文',
  'composer.addFiles': '添加文件',
  'composer.addFolder': '添加文件夹',
  'composer.setGoal': '设为目标',
  'composer.goal': '目标模式',
  'composer.clearGoal': '返回普通模式',
  'composer.file': '文件',
  'composer.folder': '文件夹',
  'composer.inspectAttachments': '请查看我添加的内容。',
  'composer.attachmentLimit': '最多添加 8 个本地文件或文件夹。',
  ...
  'effort.on': '开启',
  'effort.on.desc': '使用模型服务商的默认推理方式',
  'effort.none': '无',
  'effort.none.desc': '不使用推理力度',
  'effort.minimal': '极低',
  'effort.minimal.desc': '模型支持的最低推理力度',
  'effort.low': '低',
  'effort.low.desc': '快速、轻量推理',
  'effort.medium': '中',
  'effort.medium.desc': '均衡的推理力度',
  'effort.high': '高',
  'effort.high.desc': '较高的推理力度',
  'effort.xhigh': '超高',
  'effort.xhigh.desc': '扩展推理力度',
  'effort.max': '最高',
  ...
  'context.toolsCompacted': '工具结果已压缩（{before} → {after} tokens，共 {count} 条）。模型看到小型收据，完整输出仍保留在对话历史中。',
  ...
  'settings.compaction.hint': '上下文阈值与策略',
  'settings.plugins': '插件',
  ...
  'general.responseLanguagePlaceholder': '例如：中文；Friday 会优先使用该语言回复',
  'models.title': '模型',
  ...
  'models.model': 'Model',
  'models.apiKey': 'API key',
  'models.keyEmptyShort': '粘贴 API key 后按回车',
  'models.keyOptional': '留空则保留已保存的 key',
  'models.removeKey': '移除已保存的 API key',
  'models.saved': '已保存',
  'models.refreshed': '已刷新 {n} 个模型',
  'models.keyRemoved': 'API key 已清除',
  'models.enabled': '已启用服务商',
  'models.disabled': '已停用服务商',
  'models.enableNeedsKey': '请先填写 API key',
  'models.refresh': '刷新模型',
  'models.enable': '启用服务商',
  'models.disable': '停用服务商',
  'models.modelCount': '{n} 个模型',
  'models.customTitle': 'OpenAI 兼容服务',
  'models.customBrief': '自定义接入点',
  'models.add': '添加',
  ...
  'compaction.desc': '设置 Friday 何时改写模型可见上下文；完整对话历史仍保存在磁盘上。',
  'compaction.automatic': '自动压缩',
  'compaction.automaticNote': '关闭后，Friday 会在达到阈值时停下，并提醒你手动压缩。',
  'compaction.threshold': '触发阈值',
  'compaction.strategy': '压缩策略',
  'compaction.insert': '直接 insert and compact',
  'compaction.twoStage': '先生成工具收据，再 insert and compact',
  'compaction.manualNote': '只要压缩插件处于启用状态，就可以通过下方按钮手动压缩。',
  'compaction.compactNow': '立即压缩',
  'compaction.compacting': '正在压缩…',

  // Plugins
  'plugins.title': '插件',
  'plugins.desc': 'Harness 能力通过同一个插件注册表提供工具、提示段、包装器、记忆及压缩服务。关闭插件只会移除该插件贡献的能力。',
  'plugins.required': '必需',
  'plugins.on': '开启',
  'plugins.off': '关闭',
  'plugins.tools': '工具：{tools}',
  'plugins.prompt': '提示段',
  'plugins.wrapper': '工具包装器',
  'plugins.memory': '记忆提供者',
  'plugins.noTools': '未贡献能力',
  'plugins.compaction': '上下文压缩提供者',
