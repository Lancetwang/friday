...
const en: Record<string, string> = {
  ...
  'compaction.thresholdNote': 'Context occupancy that triggers automatic compaction.',
  ...
  'compaction.strategyNote': 'Choose what Friday does before conversation compaction.',
  'compaction.insert': 'Insert and compact',
  'compaction.insertNote': 'Summarize the conversation directly.',
  'compaction.twoStage': 'Tool receipts first',
  'compaction.twoStageNote': 'Replace older tool results with receipts before summarizing.',
...
const zh: Record<string, string> = {
  ...
  'compaction.thresholdNote': '上下文占用达到该比例时触发自动压缩。',
  'compaction.decreaseThreshold': '降低压缩阈值',
  'compaction.increaseThreshold': '提高压缩阈值',
  'compaction.strategy': '压缩策略',
  'compaction.strategyNote': '选择 Friday 在压缩对话前先处理哪些内容。',
  'compaction.insert': '直接压缩',
  'compaction.insertNote': '直接总结对话。',
  'compaction.twoStage': '先生成工具收据',
  'compaction.twoStageNote': '先将较早的工具结果替换为收据，再总结对话。',
