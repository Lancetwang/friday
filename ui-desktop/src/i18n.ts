...
const en: Record<string, string> = {
  ...
  'composer.imageRejected': 'The selected model rejected image input. Choose a model that accepts images, or remove the image and try again.',
  ...
  'settings.general.hint': 'Language, colors, and preferences',
  ...
  'theme.settingsTitle': 'Interface colors',
  'theme.settingsDesc': 'Changes apply immediately and stay on this device.',
  'theme.presets': 'Color presets',
  'theme.reset': 'Reset',
  'theme.canvas': 'Theme color',
  'theme.canvasHint': 'Window and content background',
  'theme.accent': 'Accent color',
  'theme.accentHint': 'Selection, switches, and focus',
  'theme.pickColor': 'Choose {label}',
  'theme.colorCode': '{label} color code',
  'theme.preset.fridaySky': 'Friday Sky',
  'theme.preset.radixSky': 'Radix Sky',
  'theme.preset.carbonBlue': 'Carbon Blue',
  'theme.preset.tailwindAir': 'Tailwind Air',
  'theme.preset.irisMist': 'Iris Mist',
  'theme.preset.sageStudio': 'Sage Studio',
  ...
  'compaction.automaticNote': 'Controls automatic triggering only. When off, manual compaction remains available.',
  'compaction.threshold': 'Threshold',
  'compaction.thresholdNote': 'At this occupancy, Friday compacts automatically or pauses and asks when automatic compaction is off.',
  'compaction.decreaseThreshold': 'Lower compaction threshold',
  'compaction.increaseThreshold': 'Raise compaction threshold',
  'compaction.strategy': 'Strategy',
  'compaction.insert': 'Direct compaction',
  'compaction.insertNote': 'Summarize older conversation context directly.',
  'compaction.twoStage': 'Two-stage compaction',
  'compaction.twoStageNote': 'First replace older tool results with receipts; summarize only if more space is still needed.',
  'compaction.saveSettings': 'Save compaction settings',
  'compaction.saved': 'Compaction settings saved.',
  'compaction.manualTitle': 'Compact the current conversation',
  'compaction.manualNote': 'Compact now with the settings above. Unsaved changes are applied first.',
  'compaction.pluginUnavailable': 'Compaction is disabled. Enable a compaction provider in Plugins first.',
  'compaction.compactNow': 'Compact conversation now',
  'compaction.compacting': 'Compacting conversation…',

  // Plugins
  'plugins.title': 'Plugins',
  'plugins.desc': 'Turn Harness capabilities on or off here. Configure how each capability behaves on its own settings page.',
  'plugins.required': 'Required',
  'plugins.trust': 'Trust local code and enable',
  ...
  'plugins.scope.builtin': 'Built in',
  'plugins.scope.project': 'Project',
  'plugins.scope.user': 'User',
  'plugins.builtin.workspace.name': 'Workspace',
  'plugins.builtin.workspace.description': 'Read, edit, search, plan, and run commands in the current project.',
  'plugins.builtin.web.name': 'Web',
  'plugins.builtin.web.description': 'Search the live web and fetch pages.',
  'plugins.builtin.memory.name': 'Memory',
  'plugins.builtin.memory.description': 'Store and recall durable memory across conversations.',
  'plugins.builtin.skills.name': 'Skills',
  'plugins.builtin.skills.description': 'Discover reusable procedures from FridaySkills directories.',
  'plugins.builtin.compaction.name': 'Built-in context compaction',
  'plugins.builtin.compaction.description': 'Built-in compaction provider. Without another provider, turning it off disables automatic and manual compaction.',
...
const zh: Record<string, string> = {
  ...
  'composer.imageRejected': '当前模型拒绝了图片输入。请切换支持图片的模型，或移除图片后重试。',
  ...
  // Settings nav
  'settings.general': '通用',
  'settings.general.hint': '语言、配色与偏好',
  'settings.models': '模型',
  ...
  'theme.settingsDesc': '选择后立即应用，并保存在这台设备上。',
  'theme.presets': '配色预设',
  'theme.reset': '恢复默认',
  'theme.canvas': '主题色',
  'theme.canvasHint': '窗口与内容背景',
  'theme.accent': '强调色',
  'theme.accentHint': '选中、开关与焦点',
  'theme.pickColor': '选择{label}',
  'theme.colorCode': '{label}颜色代码',
  'theme.preset.fridaySky': 'Friday 天空',
  'theme.preset.radixSky': 'Radix 晴空',
  'theme.preset.carbonBlue': 'Carbon 雾蓝',
  'theme.preset.tailwindAir': 'Tailwind 空气',
  'theme.preset.irisMist': '鸢尾晨雾',
  'theme.preset.sageStudio': '鼠尾草工作室',
  ...
  'compaction.automaticNote': '只控制是否自动触发；关闭后仍可手动压缩。',
  'compaction.threshold': '触发阈值',
  'compaction.thresholdNote': '达到该占用时自动压缩；关闭自动压缩后则暂停并提醒。',
  'compaction.decreaseThreshold': '降低压缩阈值',
  'compaction.increaseThreshold': '提高压缩阈值',
  'compaction.strategy': '压缩策略',
  'compaction.insert': '直接压缩',
  'compaction.insertNote': '直接总结较早的对话上下文。',
  'compaction.twoStage': '两阶段压缩',
  'compaction.twoStageNote': '先将较早的工具结果替换为收据；空间仍不足时再总结对话。',
  'compaction.saveSettings': '保存压缩设置',
  'compaction.saved': '压缩设置已保存。',
  'compaction.manualTitle': '压缩当前对话',
  'compaction.manualNote': '使用上方设置立即压缩；未保存的修改会先一并应用。',
  'compaction.pluginUnavailable': '压缩功能已关闭，请先在“插件”中启用压缩服务。',
  'compaction.compactNow': '立即压缩当前对话',
  'compaction.compacting': '正在压缩当前对话…',

  // Plugins
  'plugins.title': '插件',
  'plugins.desc': '在这里启用或关闭 Harness 能力；具体行为请在对应的设置页中配置。',
  'plugins.required': '必需',
  'plugins.trust': '信任本地代码并启用',
  ...
  'plugins.scope.builtin': '内置',
  'plugins.scope.project': '项目',
  'plugins.scope.user': '用户',
  'plugins.builtin.workspace.name': '工作区',
  'plugins.builtin.workspace.description': '在当前项目中读取、编辑、搜索、规划并运行命令。',
  'plugins.builtin.web.name': '联网',
  'plugins.builtin.web.description': '实时搜索网页并读取页面内容。',
  'plugins.builtin.memory.name': '记忆',
  'plugins.builtin.memory.description': '跨对话保存并按需召回持久记忆。',
  'plugins.builtin.skills.name': '技能',
  'plugins.builtin.skills.description': '从 FridaySkills 目录发现可复用流程。',
  'plugins.builtin.compaction.name': '内置上下文压缩',
  'plugins.builtin.compaction.description': '内置压缩服务；没有其他压缩服务时，关闭后自动压缩和手动压缩都会不可用。',
