...
const en: Record<string, string> = {
  ...
  'phone.secretPlaceholder': 'Paste App Secret and press Enter',
  'phone.secretSaved': 'Secret saved',
  'phone.secretRemoved': 'Secret removed',
...
const zh: Record<string, string> = {
  ...
  'phone.appIdHint': 'cli_...',
  'phone.appSecret': 'App Secret',
  'phone.secretPlaceholder': '粘贴 App Secret 后按回车',
  'phone.secretSaved': 'Secret 已保存',
  'phone.secretRemoved': 'Secret 已删除',
